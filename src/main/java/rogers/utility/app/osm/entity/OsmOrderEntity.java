...
public class OsmOrderEntity {
  ...
  @Column(name = "ORD_COMPLETION_DATE")
  private Date ordCompletionnDate;
  ...
  public Date getOrdCompletionnDate() {
	return ordCompletionnDate;
}

public void setOrdCompletionnDate(Date ordCompletionnDate) {
	this.ordCompletionnDate = ordCompletionnDate;
}
